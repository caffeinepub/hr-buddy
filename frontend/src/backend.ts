...
export class Backend implements backendInterface {
    ...
    async getAllDemoRequestsByEmail(arg0: string): Promise<Array<DemoRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDemoRequestsByEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitDemoRequest(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<CustomId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitDemoRequest(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
